...
document.getElementById('column1').innerHTML+="<p>IDK what the heck I'm Doing!!</p>";
...
document.getElementById('column2').style.color="#006935";
...
//if the weapon is squid-betta then the damage points is 50
...
document.getElementById('column3').innerHTML+=weapon+" have this much damage: "+damage+ "<p>";
